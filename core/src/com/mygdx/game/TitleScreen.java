...
public class TitleScreen implements Screen {
    private Stage stage;
    private Game game;
    public TitleScreen(Game msGame) {
        game= msGame;
        stage = new Stage(new ScreenViewport());
        Gdx.app.log("SCREEN","GameScreen");

        Label title = new Label("TITEL SCREEN",MSGame.gameSkin);
        ...
        TextButton playButton = new TextButton("PLAY!!!",MSGame.gameSkin);
        ...
        TextButton optionsButton = new TextButton("Options",MSGame.gameSkin);
        optionsButton.setWidth(Gdx.graphics.getWidth()/2);
        optionsButton.setHeight(40f);
